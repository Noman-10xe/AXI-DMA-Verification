...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x7394e0)) ;
...
extern "C" {
	...
	extern void subprog_m_ec1c6afa7c2c8008_556ead11_3468(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 509312, 168, 1653240) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_ec1c6afa7c2c8008_556ead11_3468), IP) ;
