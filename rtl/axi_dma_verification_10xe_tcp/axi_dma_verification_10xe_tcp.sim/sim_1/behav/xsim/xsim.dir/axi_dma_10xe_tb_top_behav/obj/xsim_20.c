...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x49cba8)) ;
...
extern "C" {
	...
	extern void subprog_m_c2492bfd1d873333_556ead11_2117(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 412808, 168, 1274696) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_c2492bfd1d873333_556ead11_2117), IP) ;
